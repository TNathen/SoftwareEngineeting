...
public class Flight_SeatingGUI{
    ...
    public static void main(String args[]) throws Exception{
        ...
        JFrame flightseatingGUIframe = new Flight_SeatingGUIFrame();
...
class Flight_SeatingGUIFrame extends JFrame 
{
  ...
  public Flight_SeatingGUIFrame() throws Exception
  {
    ...
    //discount
    discount thisDiscount=new discount("flight1");
    needsDiscount=thisDiscount.getDiscount();
    //tool tips
    for(int a=0;a<60;a++)
    {
		seatInfo thisSeat=new seatInfo("flight1",a+1,needsDiscount);
    	btn[a].setToolTipText(thisSeat.getInfo()+thisSeat.getPrice());
    }
    
    //disable seats that are already bought
    getPurchasedSeats thisPlane = new getPurchasedSeats("flight1");
        ...
        boolean selected = abstractButton.getModel().isSelected();
        	...
        	for(int b=0;b<60;b++)
	    	{
	    	   if (btn[b].isSelected()==true)
	    	   {
	    		   ...
	    		   try 
	    		   {
					seatInfo thisSeat=new seatInfo("flight1",b+1,needsDiscount);
